...
@Component({
  selector: 'app-dtc-alert',
  templateUrl: './dtc-alert.component.html',
  styleUrls: ['./dtc-alert.component.css']
})
export class DTCAlertComponent implements OnInit {
