...
@Component({
  selector: 'app-create-consignee',
  templateUrl: './create-consignee.component.html',
  styleUrls: ['./create-consignee.component.css']
})
export class CreateConsigneeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.proximityRadius.patchValue(1);
  }


  get addressForm() { return this.createForm.get('addressForm'); }
  get consigneeName() { return this.createForm.get('consigneeName'); }
  get consigneeCode() { return this.createForm.get('consigneeCode'); }
  get groupName() { return this.createForm.get('groupName'); }
  get consigneeCoordinates() { return this.createForm.get('consigneeCoordinates'); }
  get unloadingTime() { return this.createForm.get('unloadingTime'); }
  get geofence() { return this.createForm.get('geofence'); }
  get radiusForm() { return this.createForm.get('radiusForm'); }
  get proximityRadius() { return this.createForm.get('proximityRadius'); }
  ...
  getAddress(latitude, longitude) {
    this.consigneeCoordinates.patchValue(this.latitude + ':' + this.longitude);
  ...
  async createConsignee() {
    if (this.geofence.value == "CIRCLE") {
      ...
      this.dataObj = {
        ...
        departmentCode: this.consigneeCode.value,
        unloadingTime: this.unloadingTime.value,
        group: this.groupName.value,
        vehicleAvailabilityFenceRadius: 1,
        geoFence: {
          name: this.consigneeName.value,
          coordinates: this.consigneeCoordinates.value,
          radius: this.radiusForm.value,
          // proximityRadius: this.proximityRadius.value,
          landmark: '',
    ...
    try {
      ...
      this.router.navigate(['/dashboard/departments/consignee'])
    } catch (error) {
      console.log(error);
    }
  }
