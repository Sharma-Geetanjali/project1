...
export class ActivityLogReportService {
...
httpOptions = {
  ...
  getActivityLogReport(formData) {

    return this.http.get(`${this.url.apiV2url}um/audit?${this.serialize(formData)}`, this.httpOptions).toPromise()
