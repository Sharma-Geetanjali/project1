...
@Component({
  selector: 'app-engine-off',
  templateUrl: './engine-off.component.html',
  styleUrls: ['./engine-off.component.css']
})
export class EngineOffComponent implements OnInit {
  ...
  async getEvent() {
    ...
    try {
      ...
      this.paramObj['eventTypes'] = 'IGNITION_OFF';
