...
@Component({
  selector: 'app-engine-idling',
  templateUrl: './engine-idling.component.html',
  styleUrls: ['./engine-idling.component.css']
})
export class EngineIdlingComponent implements OnInit {
  ...
  async getEvent() {
    ...
    try {
      ...
      this.paramObj['eventTypes'] = 'IDLE_ENGINE';
