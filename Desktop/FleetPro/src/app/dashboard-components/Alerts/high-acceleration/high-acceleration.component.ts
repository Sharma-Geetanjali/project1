...
@Component({
  selector: 'app-high-acceleration',
  templateUrl: './high-acceleration.component.html',
  styleUrls: ['./high-acceleration.component.css']
})
export class HighAccelerationComponent implements OnInit,OnDestroy {
  ...
  async getEvent() {
    ...
    try {
      ...
      this.paramObj['eventTypes'] = 'HARD_ACCELERATION';
