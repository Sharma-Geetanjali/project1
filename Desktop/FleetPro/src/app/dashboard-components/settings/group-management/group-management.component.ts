...
import { MLGService } from 'src/app/Services/mlg.service';
...
export class GroupManagementComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  constructor(
    public multiService: MLGService,
