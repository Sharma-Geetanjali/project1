...
@Component({
  selector: 'app-over-speeding',
  templateUrl: './over-speeding.component.html',
  styleUrls: ['./over-speeding.component.css']
})
export class OverSpeedingComponent implements OnInit {
  ...
  async getEvent() {
    ...
    try {
      ...
      this.paramObj['eventTypes'] = 'OVER_SPEEDING';
  ...
  // mapData(val) {
  //   localStorage.setItem("alertsMapData",JSON.stringify(val))
  // }
