...
@Component({
  selector: 'app-device-plugged-in',
  templateUrl: './device-plugged-in.component.html',
  styleUrls: ['./device-plugged-in.component.css']
})
export class DevicePluggedInComponent implements OnInit {
  ...
  async getEvent() {
    ...
    try {
      ...
      this.paramObj['eventTypes'] = 'POWER_ON';
