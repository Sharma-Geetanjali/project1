...
@Component({
  selector: 'app-tkm-eol-report',
  templateUrl: './tkm-eol-report.component.html',
  styleUrls: ['./tkm-eol-report.component.css'],
  providers: [DatePipe]
})
export class TKMEOLReportComponent implements OnInit {
  @Input() max: null;
  eolAuditArr: any = [];
  tempEolAuditArr: any = [];
  filterData: any = [];
